...
- #2 - a link to your functioning GitHub Pages web site:
  ...
  - example - my Github login is `jptweb` - and this is the link to my GitHub Pages Web Site - https://jptweb.github.io/
...
1) Prof Example 
    ...
    - My Github login is `jptweb` - and this is the link to my GitHub repos - https://github.com/jptweb
    - The repo where I am posting my HTML web files is `jptweb.github.io` and that is located here - https://github.com/jptweb/tonethar.github.io
      - note the **index.html** file in the repo - that's going to be the "home page"
    - Therefore the web address of my GitHub home page is https://jptweb.github.io/
