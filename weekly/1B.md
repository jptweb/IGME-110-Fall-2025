...
### Let's brainstorm some app ideas for this specific problem using the Gen AI tools below!

----

## VI. Generative AI tools for brainstorming
- Check out RIT resources for AI (we can talk about this in class a bit): https://www.rit.edu/its/generative-ai
